...
class PolkadexExchangeUnitTests(unittest.TestCase):
  ...
  "data": {
    ...
    def test_all_data_return_functions(self):

        #self.connector.client_order_id_max_length()
        #self.connector.client_order_id_prefix()

        with self.assertRaises(NotImplementedError):
            self.connector.trading_rules_request_path()
  ...
  "data": {
    ...
    def test_balance_update_callback(self):
        ...
        print("Balance Update reached here")
        assert(1==2)
