...
class PolkadexOrderBookDataSourceUnitTests(unittest.TestCase):
  ...
  "data": {
    ...
    def test_get_last_traded_prices(self, mock_api):
      ...
      self.assertEqual(prices[self.trading_pair], 20.0)
  ...
  "data": {
    ...
    def test_on_recent_trade_callback(self, mock_api):
      ...
      self.data_source.on_recent_trade_callback(msg["websocket_streams"], self.trading_pair)
    ...
    def test_on_ob_increment(self, mock_api):
      ...
      self.data_source.on_ob_increment(msg["websocket_streams"], self.trading_pair)
